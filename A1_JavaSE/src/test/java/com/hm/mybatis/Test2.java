...
public class Test2 {
    ...
    public void insertBatch() throws Exception {
        ...
        List<UserModel> userModelList1 = MpUtil.callMapper(UserMapper.class, mapper -> mapper.getModelList(null));
    ...
    public void delete() throws Exception {
        ...
        //需要删除的用户id
        map.put("id", 15);
        Integer count = MpUtil.callMapper(UserMapper.class, mapper -> mapper.delete(map));
        log.info("删除行数：{}", count);
    }
    ...
    public void getModelList1() throws Exception {
        List<UserModel> userModelList = MpUtil.callMapper(UserMapper.class, mapper -> mapper.getModelList(null));
